...
if __name__ == "__main__":
    ...
    with open(os.path.join(path, "basic_artifacts/contract.json"), "w") as f:
        f.write(json.dumps(contract.dictify(), indent=2))

    # Write out the approval and clear programs
    with open(os.path.join(path, "basic_artifacts/approval.teal"), "w") as f:
        f.write(approval)

    with open(os.path.join(path, "basic_artifacts/clear.teal"), "w") as f:
        f.write(clear)
